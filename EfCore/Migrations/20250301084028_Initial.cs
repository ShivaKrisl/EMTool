        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PRLink = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PullRequests_Tasks_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScrumMeetings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScrumMeetings_Teams_TeamId",
                        column: x => x.TeamId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScrumAttendance", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScrumAttendance_ScrumMeetings_MeetingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScrumAttendance_MeetingId",
